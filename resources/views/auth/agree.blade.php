...
<div class="Inner">
  ...
  <p class="Inner-Text first">この利用規約（以下，「本規約」といいます。）は，＿＿＿＿＿（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
  <div class="Inner-Box">
    <h3 class="Inner-Box-Headline">適用</h3>
    <ol class="Inner-Box-List">
      <li class="Inner-Box-List-Item">本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。</li>
      <li class="Inner-Box-List-Item">当社は本サービスに関し，本規約のほか，ご利用にあたってのルール等，各種の定め（以下，「個別規定」といいます。）をすることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。</li>
  ...
  <div class="Inner-Box">
    <h3 class="Inner-Box-Headline">利用登録</h3>
    <ol class="Inner-Box-List">
      <li class="Inner-Box-List-Item">本サービスにおいては，登録希望者が本規約に同意の上，当社の定める方法によって利用登録を申請し，当社がこれを承認することによって，利用登録が完了するものとします。</li>
      <li class="Inner-Box-List-Item">当社は，利用登録の申請者に以下の事由があると判断した場合，利用登録の申請を承認しないことがあり，その理由については一切の開示義務を負わないものとします。</li>
    </ol>
    <div class="Inner-Box-Contact">
      <p class="Inner-Box-Contact-Text">個人情報保護方針、個人情報の取り扱い及び苦情及び相談に関するお問い合わせ先については、以下にご連絡下さい。</p>
      <p class="Inner-Box-Contact-Text">Email sugashi1900day@gmail.com</p>
    </div>
  </div>
</div>
